...
public class KdspDatabaseSourceManager {
    ...
    private static func GenerateNCPDView(seed: Int32, data: ref<KdspExpandedNPCData>, view: ref<KdspDatabaseViewData>) -> ref<KdspDatabaseViewData> {
        ...
        view.accentColor = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V0");
        view.iconGlyph = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V1");
        ...
        ArrayPush(view.sections, KdspDatabaseSourceManager.CreateSection(GetLocalizedTextByKey(n"Kdsp-DatabaseSource-T3"), 
            GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S1") + data.criminalRecord.warrantStatus + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5") +
        ...
        if ArraySize(data.criminalRecord.arrests) > 0 {
            ...
            while i < ArraySize(data.criminalRecord.arrests) && i < 5 {
                arrestText += GetLocalizedTextByKey(n"Kdsp-Shared-C28") + data.criminalRecord.arrests[i] + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
                i += 1;
            }
        ...
        if !Equals(data.criminalRecord.gangAffiliation, "") && !Equals(data.criminalRecord.gangAffiliation, "NONE") {
            ArrayPush(view.sections, KdspDatabaseSourceManager.CreateSection(GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U5"),
                GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S3") + data.criminalRecord.gangAffiliation + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5") +
                GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S4") + data.criminalRecord.gangRank + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5") +
        ...
        ArrayPush(view.sections, KdspDatabaseSourceManager.CreateSection(GetLocalizedTextByKey(n"Kdsp-DatabaseSource-T5"),
            GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S5") + data.psychProfile.threatDescription + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5") +
            GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S6") + data.psychProfile.armedLikelihood + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5") +
        ...
        if ArraySize(data.relationships.knownAssociates) > 0 {
            ...
            while i < ArraySize(data.relationships.knownAssociates) && i < 3 {
                ...
                assocText += GetLocalizedTextByKey(n"Kdsp-Shared-C28") + assoc.name + " - " + assoc.status + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
                i += 1;
            }
    ...
    private static func GenerateArasakaView(seed: Int32, data: ref<KdspExpandedNPCData>, view: ref<KdspDatabaseViewData>) -> ref<KdspDatabaseViewData> {
        ...
        view.accentColor = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V2");
        ...
        let assessment = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S10") + data.archetype + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        ...
        if Equals(data.archetype, "CORPO_MANAGER") || Equals(data.archetype, "CORPO_DRONE") {
            assessment += data.financialProfile.employer + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        } else {
            assessment += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-T9");
        }
        assessment += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S12") + KdspDatabaseSourceManager.GetAssetValue(data) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        ...
        let finText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S14") + IntToString(data.financialProfile.estimatedWealth) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        finText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S15") + data.financialProfile.creditTier + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        if data.financialProfile.hasDebt {
            finText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S16") + data.financialProfile.debtStatus + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        ...
        let cyberText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S19") + IntToString(data.cyberwareRegistry.totalImplants) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        cyberText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S20") + (data.cyberwareRegistry.hasIllegalCyberware ? GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V3") : GetLocalizedTextByKey(n"Kdsp-DatabaseSource-T13")) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        cyberText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S21") + data.psychProfile.combatTraining + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
    ...
    private static func CalculateCorporateThreat(data: ref<KdspExpandedNPCData>) -> String {
        ...
        return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V4");
    }

    private static func GetAssetValue(data: ref<KdspExpandedNPCData>) -> String {
        if Equals(data.archetype, "CORPO_MANAGER") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U6"); }
        if Equals(data.archetype, "CORPO_DRONE") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U7"); }
        if Equals(data.archetype, "YUPPIE") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U8"); }
        if Equals(data.archetype, "GANGER") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U9"); }
        return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V5");
    }
    ...
    private static func GenerateTraumaTeamView(seed: Int32, data: ref<KdspExpandedNPCData>, view: ref<KdspDatabaseViewData>) -> ref<KdspDatabaseViewData> {
        ...
        view.accentColor = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V6");
        ...
        // Medical priority
        let priorityText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S29") + data.financialProfile.traumaTeamCoverage + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        if StrContains(data.financialProfile.traumaTeamCoverage, "NONE") || StrContains(data.financialProfile.traumaTeamCoverage, "EXPIRED") || StrContains(data.financialProfile.traumaTeamCoverage, "LAPSED") {
            ...
            priorityText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S32") + KdspDatabaseSourceManager.GetResponsePriority(data.financialProfile.traumaTeamCoverage) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        ...
        // Medical summary
        let medText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S34") + data.medicalHistory.bloodType + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        medText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S35") + data.medicalHistory.healthRating + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        medText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S36") + (ArraySize(data.medicalHistory.allergies) > 0 ? IntToString(ArraySize(data.medicalHistory.allergies)) + GetLocalizedTextByKey(n"Kdsp-DatabaseSource-T24") : GetLocalizedTextByKey(n"Kdsp-Npc-TracyPhillips-Affiliation")) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        ...
        let cyberText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S19") + IntToString(data.cyberwareRegistry.totalImplants) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        cyberText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S38") + data.cyberwareRegistry.warrantyStatus + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        ...
        if ArraySize(data.medicalHistory.chronicConditions) > 0 {
            ...
            while i < ArraySize(data.medicalHistory.chronicConditions) {
                condText += GetLocalizedTextByKey(n"Kdsp-Shared-C28") + data.medicalHistory.chronicConditions[i] + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
                i += 1;
            }
        ...
        // Response history
        let historyText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S40") + IntToString(data.medicalHistory.emergencyVisits) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
    ...
    private static func GetResponsePriority(coverage: String) -> String {
        if StrContains(coverage, "PLATINUM") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U10"); }
        if StrContains(coverage, "GOLD") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U12"); }
        if StrContains(coverage, "SILVER") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U13"); }
    ...
    private static func GenerateNetwatchView(seed: Int32, data: ref<KdspExpandedNPCData>, view: ref<KdspDatabaseViewData>) -> ref<KdspDatabaseViewData> {
        ...
        view.accentColor = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V7");
        view.iconGlyph = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V8");
        ...
        // Digital footprint
        let digitalText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S44") + KdspDatabaseSourceManager.GetNetActivityLevel(seed, data.archetype) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        ...
        digitalText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S46") + KdspDatabaseSourceManager.GetEncryptionLevel(seed, data.archetype) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        digitalText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S47") + (RandRange(seed + 10, 1, 100) <= 40 ? GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V3") : GetLocalizedTextByKey(n"Kdsp-DatabaseSource-T13"));
        ...
        let blackwallText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S48") + (RandRange(seed + 20, 1, 1000) == 1 ? GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V9") : GetLocalizedTextByKey(n"Kdsp-DatabaseSource-T13")) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        blackwallText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S49");
        blackwallText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S50") + (RandRange(seed + 30, 1, 100) <= 20 ? GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V3") : "NONE");
        ...
        // Monitoring status
        let monitorText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U14") + (Equals(netThreat, "HIGH") ? GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U16") : GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U17")) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
    ...
    private static func CalculateNetThreat(seed: Int32, data: ref<KdspExpandedNPCData>) -> String {
        ...
        if score >= 30 { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V10"); }
    ...
    private static func GetNetActivityLevel(seed: Int32, archetype: String) -> String {
        ...
        ArrayPush(levels, GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V11"));
        ArrayPush(levels, GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V10"));
    ...
    private static func GetEncryptionLevel(seed: Int32, archetype: String) -> String {
        if Equals(archetype, "CORPO_MANAGER") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U18"); }
        if Equals(archetype, "CORPO_DRONE") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U19"); }
        if Equals(archetype, "YUPPIE") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U20"); }
        if Equals(archetype, "GANGER") { return RandRange(seed, 1, 100) <= 50 ? GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V12") : GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V13"); }
    ...
    private static func GenerateStreetView(seed: Int32, data: ref<KdspExpandedNPCData>, view: ref<KdspDatabaseViewData>) -> ref<KdspDatabaseViewData> {
        ...
        view.accentColor = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V14");
        ...
        // Word on the street
        let wordText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S61") + rep + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        wordText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S62") + (RandRange(seed, 1, 100) <= 30 ? KdspDatabaseSourceManager.GenerateStreetNickname(seed) : GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S63")) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        wordText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S64") + KdspDatabaseSourceManager.GetReliability(seed, data.archetype);
        ArrayPush(view.sections, KdspDatabaseSourceManager.CreateSection(GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V15"), wordText));

        // Connections
        if !Equals(data.gangProfile.gangAffiliation, "NONE") && !Equals(data.gangProfile.gangAffiliation, "") {
            let gangText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S65") + data.gangProfile.gangName + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
            gangText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S4") + data.gangProfile.memberRank + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        ...
        let dangerText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S67") + data.psychProfile.armedLikelihood + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        dangerText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S68") + (data.psychProfile.threatLevel >= 50 ? GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S69") : GetLocalizedTextByKey(n"Kdsp-DatabaseSource-T53")) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        ...
        if ArraySize(data.districtProfile.localConnections) > 0 {
            ...
            while i < ArraySize(data.districtProfile.localConnections) && i < 3 {
                hangoutText += GetLocalizedTextByKey(n"Kdsp-Shared-C28") + data.districtProfile.localConnections[i] + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
                i += 1;
            }
    ...
    private static func GetReliability(seed: Int32, archetype: String) -> String {
        if Equals(archetype, "JUNKIE") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U23"); }
        if Equals(archetype, "GANGER") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U24"); }
        if Equals(archetype, "CORPO_MANAGER") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U25"); }
        if Equals(archetype, "NOMAD") { return GetLocalizedTextByKey(n"Kdsp-DatabaseSource-U26"); }
    ...
    private static func GetStreetSkills(seed: Int32, data: ref<KdspExpandedNPCData>) -> String {
        ...
        while i < ArraySize(skills) && i < 3 {
            result += GetLocalizedTextByKey(n"Kdsp-Shared-C28") + skills[i] + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
            i += 1;
        }
        return result;
    }
    ...
    private static func GenerateMedicalView(seed: Int32, data: ref<KdspExpandedNPCData>, view: ref<KdspDatabaseViewData>) -> ref<KdspDatabaseViewData> {
        ...
        view.accentColor = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V16");
        view.iconGlyph = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-V17");
        ...
        vitalsText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S34") + data.medicalHistory.bloodType + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        vitalsText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S83") + data.medicalHistory.height + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        ...
        if ArraySize(data.medicalHistory.currentMedications) > 0 {
            ...
            while i < ArraySize(data.medicalHistory.currentMedications) {
                medText += GetLocalizedTextByKey(n"Kdsp-Shared-C28") + data.medicalHistory.currentMedications[i] + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
                i += 1;
            }
        ...
        // Cyberware summary
        let cyberText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S19") + IntToString(data.cyberwareRegistry.totalImplants) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        cyberText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S85") + data.cyberwareRegistry.lastRipperdocVisit + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        ...
        // Visit history
        let visitText = GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S86") + data.medicalHistory.lastCheckup + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        visitText += GetLocalizedTextByKey(n"Kdsp-DatabaseSource-S87") + IntToString(data.medicalHistory.ripperdocVisits) + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
        ...
        if ArraySize(data.medicalHistory.allergies) > 0 {
            ...
            while i < ArraySize(data.medicalHistory.allergies) {
                allergyText += "⚠ " + data.medicalHistory.allergies[i] + GetLocalizedTextByKey(n"Kdsp-BackstoryManag-U5");
                i += 1;
            }
