...
<p align="center">
  ...
  and personal relationships.<br><br>
...
<p align="center">
  <img src="/branding/stats_top.svg" alt="Stats" width="100%">
</p>
<p align="center">
  <img src="/branding/stats_bottom.svg" alt="Stats" width="100%">
</p>
...
<img src="/branding/section_overview.svg" alt="Overview" width="100%">

Deep Scan Protocol hooks your Kiroshi optics into every major database in Night City. Scan any civilian and pull their NCPD criminal records, cyberware registry, bank records, medical history, psychological profile, and personal relationships. Scan gang members for affiliation intel and procedurally generated names. Scan NCPD officers for detailed personnel files. Scan named characters for hand-written, lore-accurate classified dossiers.
...
<img src="/branding/section_databases.svg" alt="Database Access" width="100%">
...
> **Smart Filtering:** Gang members won't show bank records. NCPD officers have sealed criminal files. Trauma Team members show military-grade profiles with operational security redactions. Children display protected status only. Military combat NPCs show vanilla scanner data to prevent crashes. Fake police are detected and flagged as impersonators.
...
| Mickey | Santo Domingo | El Capitan's driver/courier |
...
<details>
<summary><b>▸ BEAT ON THE BRAT</b> — 2 entries</summary>

| Character | Classification | Notes |
|:--|:--|:--|
| Certo Esquerdo | UNDERGROUND FIGHTER | Twin. Brazilian martial arts. Cross-references brother. |
| Esquerdo Certo | UNDERGROUND FIGHTER | Twin. Coordinated threat assessment. |
...
**EBM Petrochem Stadium:** Sophia Dupont · David Walker · Herold Lowe · Sammy Taylor · Saki Seo · Eron Acedo · Marcin Iwiński (Easter egg) · Michał Kiciński (Easter egg)
...
<details>
<summary><b>▸ BLACK SAPPHIRE PARTY</b> — 12 entries</summary>

Jago Szabó · Chester Bennett · Charles Graham · Jun Azegami · Marcus Ichida · Ruth Dzeng · Ziggy Q · Arif Iqbal · Josh Kavorkin · Reverend Colver · Aurore Cassel · Aymeric Cassel

</details>

<details>
<summary><b>▸ OTHER NOTABLE CHARACTERS</b> — 8 entries</summary>

Delamain (AI taxi) · Mama Welles (Jackie's mother) · Cynthia Najarro (Pepe's wife) · Zen Master (Anomalous entity) · Nibbles (V's cat) · Brendan (Sentient vending machine) · Skippy (Sentient pistol) · Frank Nostra (V's Arasaka corpo friend)
...
<img src="/branding/section_procedural.svg" alt="Procedural Generation" width="100%">
...
### ░ NCPD Officer Profiles &nbsp; <img src="https://img.shields.io/badge/v2.2-5ef6e1?style=flat-square&labelColor=0a0e14" alt="v2.2">

Two-part combinatorial backstories for every NCPD officer. 40 origins × 25 career paths, 40 defining events × 25 career details, 40 current situations × 30 developing elements. Content includes partner deaths, IA investigations, corruption, undercover work, Cyberpsycho PTSD, bribery attempts, substance issues, and gang threats. **~1.2 billion unique officer profiles.**

### ░ Gang Member Names &nbsp; <img src="https://img.shields.io/badge/v2.2-5ef6e1?style=flat-square&labelColor=0a0e14" alt="v2.2">

Generic gang NPCs receive procedurally generated names from ethnicity-appropriate pools. Tyger Claws pull from Japanese/Chinese/Korean, Valentinos from Hispanic, Voodoo Boys from Haitian, Maelstrom from Slavic/European. **320 gang-flavored street aliases** — "Kitsune" for a Tyger Claw, "El Santo" for a Valentino, "Flatline" for Maelstrom, "Bull" for Animals. 65% alias chance. NPCs with real game names keep them.

### ░ Fake Police Detection &nbsp; <img src="https://img.shields.io/badge/v2.2-5ef6e1?style=flat-square&labelColor=0a0e14" alt="v2.2">

NPCs flagged as fake police in the game database are identified as impersonators. Forged credentials, stolen badges, criminal records for identity theft and fraud. Background overridden with ⊘ FLAGGED credential alerts. Your Kiroshi catches what other cops miss.
...
<img src="/branding/section_classifications.svg" alt="Special Classifications" width="100%">
...
<img src="/branding/section_relationships.svg" alt="Relationships" width="100%">
...
<img src="/branding/section_names.svg" alt="Name Generation" width="100%">

280,000+ unique full names across 13 culturally appropriate ethnic groups matched to NPC appearance. Zero array allocation at runtime — fully index-based for stack safety.
...
> **20,000 combinations per ethnicity × 13 = 260,000+ unique names.** Plus 320 street aliases across 10 gang-specific pools and 120 general aliases.

<br>

<img src="/branding/section_coherence.svg" alt="Narrative Coherence" width="100%">
...
<img src="/branding/section_glitches.svg" alt="Scanner Glitches" width="100%">
...
<img src="/branding/section_config.svg" alt="Configuration" width="100%">
...
<img src="/branding/section_install.svg" alt="Installation" width="100%">
...
<img src="/branding/section_compat.svg" alt="Compatibility" width="100%">
...
<img src="/branding/section_faq.svg" alt="FAQ" width="100%">
...
<details>
<summary><b>▸ Why does a gang member have a name now?</b></summary>
<br>
New in v2.2 — generic gang NPCs receive procedurally generated names from culturally appropriate name pools, with a 65% chance of a gang-flavored street alias. Named gang NPCs from the game keep their real names.
</details>

<details>
<summary><b>▸ Why does a Beat Cop have such a detailed backstory?</b></summary>
<br>
NCPD profiles were completely overhauled in v2.2. Officers now get two-part combinatorial backstories — origin story + career path, defining event + career detail, current assignment + developing situation. ~1.2 billion unique profiles covering corruption, partner deaths, IA investigations, and the everyday grind of policing Night City.
</details>
...
<img src="/branding/section_arch.svg" alt="Technical Architecture" width="100%">
...
let isFakeCop = StrContains(StrLower(recordIdStr), "fake_police");
...
<img src="/branding/section_changelog.svg" alt="Changelog" width="100%">

See [CHANGELOG.md](CHANGELOG.md) for full version history.

<br>

<img src="/branding/section_credits.svg" alt="Credits" width="100%">
...
<img src="/branding/section_license.svg" alt="License" width="100%">
